...
function check_composer() {
  if ! command -v /home/dh_nq4pn3/bin/composer &> /dev/null; then
    die "/home/dh_nq4pn3/bin/composer is not installed"
  fi
}
...
function main() {
  ...
  /home/dh_nq4pn3/bin/composer init --no-interaction --name="myonlinestartup/dfyblog"
  /home/dh_nq4pn3/bin/composer config repositories.0 composer https://composer.deliciousbrains.com
  /home/dh_nq4pn3/bin/composer config --json extra.installer-paths.wp-content/plugins/{\$name} [\"type:wordpress-plugin\"]
  echo "{
    \"http-basic\": {
  ...
  /home/dh_nq4pn3/bin/composer config --no-plugins allow-plugins.composer/installers true
  /home/dh_nq4pn3/bin/composer require deliciousbrains-plugin/wp-migrate-db-pro
