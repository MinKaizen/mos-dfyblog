...
find ./wp-content -type d -regex '.*\.git$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*node_modules$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*\.log$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*\.sql$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*\.zip$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*\.tar$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*\.7s$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type d -regex '.*\.gzip$' -print >> "$TEMP_EXCLUSIONS_FILE"
