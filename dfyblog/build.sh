...
find ./wp-content -type f -regex '.*\.log$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type f -regex '.*\.sql$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type f -regex '.*\.zip$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type f -regex '.*\.tar$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type f -regex '.*\.7s$' -print >> "$TEMP_EXCLUSIONS_FILE"
find ./wp-content -type f -regex '.*\.gzip$' -print >> "$TEMP_EXCLUSIONS_FILE"
